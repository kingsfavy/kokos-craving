function getValue(){
  document.getElementById("firstelem"). innerHTML = "Making you look good and healthy is our goal thereby We bring to you the best and mouth watery small chops such as samosa, mosa, cocktail puff puff,stick meat, spring roll, etc. our small chops are tasty and at an affordable price. also we  render home delivery. but for now places we can deliver are 'Uyo' and 'Abak'. our packages varries so are the prices and it is also price friendly." + "<br>" + "<br>" + "<br>" +
  ...
  "STICK MEAT" + "_______________________________________________" + "#2000" +"<br>" + "<br>" +
   "SPRING ROLL" + "_______________________________________________" + "#2000" + "<br>" + "<br>" + "<br>" +
    ...
    "FOR SMOOTHIES" + "<br>" + "<br>" + "<br>" +
       "PACKAGES" +"________________;________________________" +  "PRICES" + "<br>" + "<br>" +
